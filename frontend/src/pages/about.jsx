  ...
  return (
    <section className="pb-12">
      ...
      <section>
        ...
        <div className="bg-[#f4f8f4] rounded-xl p-8 mt-10">
          {/* Two columns */}
          ...
          <div className="relative rounded-lg overflow-hidden">
            ...
            />
            <button className="absolute bottom-4 left-4 bg-[#C8F8A9] text-green-900 px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-green-200 transition">
