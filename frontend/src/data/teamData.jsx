export const teamData = [
  {
    ...
    linkedin: "https://www.linkedin.com/in/johnatan-moralle",
    description: `
...
Johnatan Moralle received an MBA from MIT’s Sloan School of Management. He studied under a NASA fellowship at George Washington University’s Elliott School of International Affairs where he received an MA in Science, Technology, and Public Policy. Johnatan Moralle was a President’s Scholar at Georgia Tech and received a BS with Honors in Aerospace Engineering.
  ...
  },
  {
    ...
    description: `
      Sarah leads our tech team with a passion for innovation. With a background 
      in AI and software architecture, she ensures our systems remain robust and 
      future-ready.
    `,
  },
  {
    ...
    description: `
      David brings creativity and user-focused design to every project, ensuring 
      our clients get beautiful, intuitive experiences.
    `,
  },
  {
    id: "daniel-brila",
    ...
    description: `
      Daniel oversees operations and growth strategies, ensuring the company 
  ...
  },
  {
    ...
    description: `
      Rebeca manages all tax and compliance processes, bringing expertise in 
