  ...
  return (
    <section className="bg-[#f1f5f1] text-center py-16 px-4">
      <h2 className="text-3xl md:text-5xl font-light text-black mb-8">
        Stay Ahead. Subscribe for <span className="italic">Expert Insights.</span>
      </h2>
      ...
      <form className="flex flex-col md:flex-row justify-center items-center gap-4 max-w-xl mx-auto">
        <input
          type="email"
          placeholder="Email"
          className="w-full md:w-2/3 px-4 py-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-600"
        />
        <button
          type="submit"
      ...
      <p className="text-xs text-gray-500 mt-4 max-w-lg mx-auto">
        ...
        View our <span className="underline  text-blue-900 cursor-pointer">Privacy Policy</span>.
      </p>
    </section>
  );
};
